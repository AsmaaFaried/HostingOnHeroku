...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="container">
    ...
    @csrf
        <h1 style="color:aliceblue; text-align:center;">Workspace Rooms</h1>
        <table class="table">
        ...
        <tbody style="background-color:aliceblue;">
          ...
          <tr>
            ...
            <th><a href="/editimage/{{$room ->id}}" class="btn btn-success" >Edit</a></th>
            <th><a href="/deleteimage/{{$room ->id}}" class="btn btn-danger" >Delete</a></th>
      ...
      <div class="form-group row mb-0">
        <div class="col-md-6 offset-md-4">
          <a href="{{route('addroom')}}" class="btn btn-outline-primary" style="width:200px;">
          Add another room
          </a>
